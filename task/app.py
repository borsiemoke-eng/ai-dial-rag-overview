...
FAISS_PATH = 'microwave_faiss_index'
DOC_PATH = 'microwave_manual.txt'
...
class MicrowaveRAG:
    ...
    def _setup_vectorstore(self) -> VectorStore:
        ...
        if os.path.exists(FAISS_PATH):
            ...
            vector_store = FAISS.load_local(folder_path=FAISS_PATH, embeddings=self.embeddings, allow_dangerous_deserialization=True)
        else:
            #  - Otherwise:
            #       - Create new index
    ...
    def _create_new_index(self) -> VectorStore:
        ...
        #       - encoding is `utf-8`
        text_loader = TextLoader(file_path=DOC_PATH, encoding='utf-8')
    ...
    def retrieve_context(self, query: str, k: int = 4, score=0.3) -> str:
        ...
        chunks_with_scores = self.vectorstore.similarity_search_with_relevance_scores(query=query, k=k, score_threshold=score)
